...
![The solar_cap rule on the reference day: reservation cap, floor, SoC comparison](../assets/solar_limit_algorithm.png)
...
![What headroom does: reconstructing an underestimated forecast](../assets/solar_limit_headroom.png)
