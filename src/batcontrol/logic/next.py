...
class NextLogic(LogicInterface):
    ...
    def calculate(self, input_data: CalculationInput,
        ...
        self.calculation_output.effective_min_grid_charge_soc = (
            self._calculate_effective_min_grid_charge_soc(input_data)
        )
    ...
    def _is_discharge_allowed(self, calc_input: CalculationInput,
        ...
        forecast_target_active = self._is_forecast_target_raised()
        min_grid_charge_soc_active = (
            ...
            and (
                ...
                or self._has_grid_charge_soc_price_signal(
                    consumption,
                    prices,
                    max_slots,
                    current_price,
    ...
    def _get_required_recharge_energy(self, calc_input: CalculationInput,
        ...
        if required_energy == 0.0 and not self._is_forecast_target_raised():
    ...
    def _calculate_effective_min_grid_charge_soc(
    ...
    def _is_forecast_target_raised(self) -> bool:
