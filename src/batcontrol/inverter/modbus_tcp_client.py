"""Generic hand-rolled Modbus-TCP client (MBAP framing over a raw socket).

Shared by inverter backends that talk plain Modbus TCP (e.g. fronius_modbus,
deye). No third-party Modbus library is used anywhere in this project.
"""
